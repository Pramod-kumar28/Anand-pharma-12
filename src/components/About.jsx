...
//         <Header/>
//       {/* Hero Section */}
//       <section className="text-white py-20 bg-gradient-to-br from-blue-900 via-blue-900 to-blue-900 h-[50vh] relative overflow-hidden">
...
const About = () => {
      ...
      <div className="bg-white rounded-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-2 gap-2 p-2 items-start">
        ...
        <div className="space-y-6">
          <div className="relative overflow-hidden slide-in-left">
            ...
            <div className="absolute bottom-4 right-4 lg:bottom-5 lg:right-20 sm:bottom-10 sm:right-20 scale-in">
              <div className="bg-white px-4 py-3 rounded-lg shadow-lg font-semibold text-gray-700 border border-gray-100 transform hover:scale-105 transition-transform duration-300">
                <div className="uppercase text-lg tracking-wide text-center text-blue-600 font-bold">ANAND</div>
                <div className="text-xs text-gray-500 text-center">Founder & Chairman</div>
              </div>
            </div>
          </div>
          ...
          {/* Quote below image */}
          <blockquote className="border-l-4 border-blue-500 pl-4 italic text-gray-700 bg-blue-50 rounded-lg p-4 text-base slide-in-left">
            "We don't just deliver medicines; we deliver trust. Every prescription fulfilled is a life improved, every doorstep reached is a promise kept for healthier communities."
          </blockquote>
        </div>
        ...
        <div className="pt-6 slide-in-right">
          <h2 className="text-3xl font-bold text-slate-800 mb-2">Our Story</h2>
          <p className="text-sm text-blue-700 font-medium">Founded with a Vision for Better Healthcare</p>

          {/* Description */}
          <div className="mb-6 space-y-4 mt-6">
            <p className="text-gray-700 leading-relaxed text-base fade-in">
              Under the visionary leadership of our Founder, Mr. Anand, Anand Pharma was established on the foundational principle of 
              <span className='font-bold text-blue-600'> "Healthcare for All"</span> — ensuring that quality medicines reach everyone, everywhere, within minutes.
            </p>
            <p className="text-gray-700 leading-relaxed text-base fade-in">
              With a background in pharmaceutical sciences and a passion for healthcare innovation, Mr. Anand envisioned a future where technology bridges the gap between pharmacies and patients, making healthcare truly accessible.
            </p>
          ...
          <div className="mt-8 fade-in">
            ...
            <div className="space-y-3">
              {[
                ...
                <div 
                  key={index}
                  className="flex items-center text-gray-700 p-3 rounded-lg hover:bg-blue-50 transition-all duration-300 transform hover:translate-x-2"
                >
  ...
  // Stats Section Component
  const StatsSection = () => (
    <section className="py-6 text-black w-full bg-gradient-to-br from-blue-50 to-gray-50">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            { count: 30, label: 'Delivery Time', icon: 'fas fa-clock' },
            { count: 100, label: 'Cities Covered', icon: 'fas fa-map-marker-alt' },
            { count: 50000, label: 'Medicines Available', icon: 'fas fa-pills' },
            { count: 100, label: 'Pharmacy Partners', icon: 'fas fa-handshake' }
          ].map((stat, index) => (
            <div key={index} className="p-6 fade-in group hover:scale-105 transition-transform duration-300">
              <i className={`${stat.icon} text-blue-600 text-3xl mb-4 group-hover:scale-110 transition-transform duration-300`}></i>
  ...
  return (
    <div className="overflow-hidden pt-14">
      ...
      <section className="relative text-white py-20 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 min-h-[60vh] overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <motion.h1 
            className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 fade-in"
          >
            Anand Pharma
          </motion.h1>
          <div className="w-24 h-1 bg-blue-300 mx-auto mb-6 scale-in"></div>
          <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-8 fade-in animation-delay-300 text-blue-100 leading-relaxed">
            Revolutionizing healthcare delivery through innovation, trust, and accessibility
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto mt-12">
            {[
              ...
              <div 
                key={index}
                className="bg-white/10 backdrop-blur-sm rounded-xl p-4 fade-in"
        ...
        {/* Scroll Indicator */}
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 fade-in animation-delay-2000">
      ...
      <section className="py-6 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-blue-800 mb-4 fade-in">Our Guiding Principles</h2>
            <div className="w-20 h-1 bg-blue-500 mx-auto mb-8 scale-in"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {missionPillars.map((pillar, index) => (
              <div 
                key={index} 
                className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl text-center fade-in group hover:-translate-y-2 transition-all duration-500 border border-gray-100"
                style={{ animationDelay: `${index * 200}ms` }}
              >
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-4 group-hover:text-blue-600 transition-colors duration-300">{pillar.title}</h3>
                <p className="text-gray-600 leading-relaxed">{pillar.description}</p>
              </div>
            ))}
          </div>
      ...
      {/* Our Approach Section */}
      <section className="py-6 bg-gradient-to-br from-blue-50 to-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-blue-800 mb-4 fade-in">Our Approach to Healthcare</h2>
              <div className="w-20 h-1 bg-blue-500 mx-auto mb-8 scale-in"></div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
              <div className="space-y-6 text-gray-700 leading-relaxed text-lg">
                <p className="fade-in">
                  At Anand Pharma, we believe that <span className="font-semibold text-blue-600">when it comes to health, every moment matters</span>. 
                  Our innovative platform was built on the conviction that timely access to medication should never be a privilege, but a fundamental right.
                </p>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-6 mt-8 border border-blue-200 fade-in">
            ...
            {teamValues.map((value, index) => (
              ...
              >
                <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mb-4 group-hover:bg-blue-200 transition-colors duration-300">
                  <i className={`${value.icon} text-blue-600 text-xl`}></i>
                </div>
                <h3 className="text-lg font-bold text-gray-800 mb-3">{value.title}</h3>
                <p className="text-gray-600 text-sm leading-relaxed">{value.description}</p>
              </div>
...
// Simple motion component since we can't import Framer Motion
const motion = {
