...
const CovidDetail = () => {
  ...
  const handleBuyNow = () => {
    if (prescriptionRequired) {
      alert("⚠️ This product requires a doctor's prescription. Please consult your healthcare provider before purchase.");
      return;
    }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
        ...
        <div>
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div className="flex flex-col">
                ...
                <span className={`font-medium ${prescriptionRequired ? "text-red-600" : "text-green-600"}`}>
                  {prescriptionRequired ? "Required ⚕️" : "Not Required"}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <h3 className="font-semibold text-yellow-900 mb-2">⚠️ Safety First</h3>
            <ul className="text-xs text-yellow-800 space-y-1">
              <li>• Read instructions carefully before use</li>
              <li>• Follow all safety guidelines</li>
              <li>• Keep away from children</li>
              <li>• Store in cool, dry place</li>
              {product.category === "Sanitizer" && <li>• Keep away from flames</li>}
              {product.category === "Oxygen Therapy" && <li>• No smoking near device</li>}
            </ul>
          </div>
        ...
        <div>
          ...
          {product.warnings && (
            <div className="mb-6 bg-red-50 border border-red-200 rounded-lg p-4">
              <h3 className="font-semibold text-red-900 mb-2">⚠️ Important Warnings</h3>
              <p className="text-red-800 text-sm">{product.warnings}</p>
              <div className="mt-2 text-xs text-red-700">
                <p>• For emergency numbers, call 1075</p>
                <p>• Follow all COVID safety protocols</p>
                <p>• Consult doctor for medical advice</p>
              </div>
            </div>
          )}
          ...
          <div className="border-t pt-6">
            <div className="flex items-center gap-4 mb-4">
              ...
              <span className="text-sm text-gray-500">
                {prescriptionRequired ? "(Max: 1 per order)" : "(Max: 5 per order)"}
              </span>
            </div>
      ...
      <div className="border-t pt-8 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white border border-red-200 rounded-lg p-4">
            <h3 className="font-semibold text-red-900 mb-2">😷 Mask Usage</h3>
            <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
              <li>Wear mask covering nose and mouth</li>
              <li>Change mask every 8 hours</li>
              <li>N95 masks are single-use only</li>
              <li>Dispose of masks properly</li>
            </ul>
          </div>
          <div className="bg-white border border-blue-200 rounded-lg p-4">
            <h3 className="font-semibold text-blue-900 mb-2">🧴 Sanitization</h3>
            <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
              <li>Use 70% alcohol-based sanitizer</li>
              <li>Rub hands for 20 seconds</li>
              <li>Sanitize frequently touched surfaces</li>
              <li>Wash hands with soap regularly</li>
            </ul>
          </div>
          <div className="bg-white border border-green-200 rounded-lg p-4">
            <h3 className="font-semibold text-green-900 mb-2">🏥 Home Monitoring</h3>
            <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
              <li>Check temperature twice daily</li>
              <li>Monitor oxygen levels (SpO2)</li>
              <li>Watch for breathing difficulties</li>
              <li>Isolate if symptoms appear</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-8">
        <h3 className="text-xl font-bold text-red-900 mb-4">🚨 When to Seek Emergency Help</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {relatedProducts.map(relatedProduct => (
              <div
                ...
                onClick={() => navigate(`/ProductDetail/CovidEssentialsDetail/${relatedProduct.id}`, { 
      ...
      <div className="mt-8 bg-gray-50 border border-gray-300 rounded-lg p-4 text-sm text-gray-600">
        <p><strong>Disclaimer:</strong> This product is for preventive/protective purposes only. For medical emergencies, contact healthcare professionals immediately. Follow all government guidelines and advisories. Use products as per instructions only. Some products may require prescription as per regulations.</p>
      </div>
    </div>
  );
};
