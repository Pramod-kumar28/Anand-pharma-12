    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
        ...
        <div>
          ...
          {(product.composition || product.chemical_name) && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
              ...
              {product.composition && (
                <div className="mb-2">
                  <p className="text-sm text-blue-800 font-medium">Full Composition:</p>
                  <p className="text-blue-900 text-sm bg-blue-100 p-2 rounded mt-1">{product.composition}</p>
                </div>
              )}
              {product.chemical_name && (
                <div>
                  <p className="text-sm text-blue-800 font-medium">Chemical Name:</p>
                  <p className="text-blue-900 text-sm">{product.chemical_name}</p>
                </div>
              )}
            </div>
          )}
          ...
          <div className="bg-teal-50 border border-teal-200 rounded-lg p-4 mb-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <div className="flex flex-col">
                ...
                <span className="font-medium">{product.country_of_origin || "Not specified"}</span>
              </div>
            </div>
          </div>
          ...
          <div className="mb-4 bg-purple-50 border border-purple-200 rounded-lg p-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold text-lg text-purple-900">₹{product.final_price * quantity}</span>
              </div>
              {product.cost > product.final_price && (
                <div className="flex justify-between">
        ...
        <div>
          ...
          <div className="mb-4">
            ...
            {product.chemical_name && product.chemical_name !== "Not applicable (Medical Device)" && (
              <div className="flex items-center gap-2 mb-2">
            ...
            {/* For medical devices */}
            {product.chemical_name === "Not applicable (Medical Device)" && (
              <div className="flex items-center gap-2 mb-2">
          ...
          {product.composition && (
            <div className="mb-6 bg-white border border-blue-300 rounded-lg p-4 shadow-sm">
              ...
              <div className="bg-blue-50 p-3 rounded-lg">
                <p className="text-blue-800 font-medium">{product.composition}</p>
              </div>
          ...
          <div className="mb-6 bg-red-50 border border-red-200 rounded-lg p-4">
            ...
            <div className="mt-2 text-xs text-red-600">
              <p><strong>Note:</strong> Always verify chemical composition with your healthcare provider before use.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white border border-blue-200 rounded-lg p-4">
              ...
              <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
                ...
                <li>Store at recommended temperature</li>
                <li>Keep out of reach of children</li>
              </ul>
            </div>
            <div className="bg-white border border-blue-200 rounded-lg p-4">
              <h3 className="font-semibold text-blue-900 mb-2">Safety Precautions</h3>
              <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
            ...
            <div className="bg-white border border-blue-200 rounded-lg p-4">
              <h3 className="font-semibold text-blue-900 mb-2">Chemical Information</h3>
              <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
                <li>For medical use only</li>
                <li>Do not share medications</li>
                <li>Complete the prescribed course</li>
                <li>Follow chemical handling guidelines</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          <div className="flex items-start gap-2">
            <span className="text-red-500 mt-1">💊</span>
            <span>Always verify chemical composition with your healthcare provider</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-red-500 mt-1">🩺</span>
            <span>Monitor for symptoms of hypoglycemia (low blood sugar)</span>
          ...
          <div className="flex items-start gap-2">
            <span className="text-red-500 mt-1">🧪</span>
            <span>Store medications as per chemical stability requirements</span>
          </div>
          <div className="flex items-start gap-2">
            <span className="text-red-500 mt-1">⚕️</span>
            <span>Keep emergency glucose tablets handy</span>
            ...
            {relatedProducts.map(relatedProduct => (
              ...
              >
                ...
                <div className="p-3">
                  ...
                  {relatedProduct.chemical_name && relatedProduct.chemical_name !== "Not applicable (Medical Device)" && (
