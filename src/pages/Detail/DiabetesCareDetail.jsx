    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div>
          ...
          <div className="mb-4">
            ...
            {product.chemical_name === "Not applicable (Medical Device)" && (
              <div className="flex items-center gap-2 mb-2">
                <i className="fas fa-stethoscope text-gray-600 text-lg"></i>
          ...
          <div className="mb-6 bg-red-50 border border-red-200 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-2">
              <i className="fas fa-file-medical text-red-500 text-xl"></i>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white border border-gray-200 rounded-lg p-4">
            ...
            <ul className="text-sm text-gray-600 space-y-2">
              ...
              <li className="flex items-start gap-2">
                <i className="fas fa-check text-green-500 mt-1"></i>
                Never skip doses or change dosage without consultation
              </li>
              <li className="flex items-start gap-2">
                <i className="fas fa-check text-green-500 mt-1"></i>
      ...
      <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          <div className="flex items-start gap-2">
            <i className="fas fa-temperature-low text-red-500 mt-1"></i>
            <span>Store medications as per chemical stability requirements</span>
          </div>
          <div className="flex items-start gap-2">
            <i className="fas fa-medkit text-red-500 mt-1"></i>
