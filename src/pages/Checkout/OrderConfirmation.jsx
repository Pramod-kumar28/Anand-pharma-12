...
//   // Use useRef to track if we've already processed the order
//   const hasProcessedOrder = useRef(false);
  
//   // Generate order ID only once using useRef
...
//     // Get order details from location state or generate new ones
//     if (location.state?.orderDetails) {
//       setOrderDetails(location.state.orderDetails);
//       setLoading(false);
      
//       // Clear cart after successful order
//       if (location.state.orderDetails.status === "confirmed") {
//         setTimeout(() => {
//           clearCart();
//         }, 100);
//       }
//     } else {
//       // Generate mock order details if not passed
//       const mockOrder = {
...
//       // Clear cart with delay to avoid state updates during render
//       setTimeout(() => {
//         clearCart();
//       }, 100);
//     }
